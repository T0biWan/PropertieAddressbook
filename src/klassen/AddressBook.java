...
public class AddressBook implements AddressbookInterface {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see classes.AddressBookInterface#addDetails(classes.ObservableContactDetails)
	 */
	@Override
	 ...
	 * classes.ObservableContactDetails)
	 */
	@Override
	 ...
	 */
	@Override
	public ObservableContactDetails[] search(String keyPrefix) throws ParameterStringIsEmptyException, DetailsNotFoundException {
		...
		List<ObservableContactDetails> matchedDetails = new ArrayList<ObservableContactDetails>();
		...
		for (String prefix : keyPrefixArray) {
			...
			for (String key : namesMap.keySet()) {
				...
				if (key.contains(prefix)) {
					...
					// und holen uns die ObservableContactDetails
	 ...
	 * (non-Javadoc)
	 * 
	 * @see classes.AddressBookInterface#generateKey(classes.ObservableContactDetails)
	 */
	@Override
	public String generateKey(ObservableContactDetails details)throws ParameterStringIsEmptyException {
		...
		// ObservableContactDetails entgegen
